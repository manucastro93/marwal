...
const { singleUpload, multipleUpload, singleUploadLogo, singleUploadBanner } = require('../middlewares/multer');
...
router.post('catalogo/clientes', clienteController.crearOActualizarCliente);
